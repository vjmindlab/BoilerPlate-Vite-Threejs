...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ln,depthTest:!1,depthWrite:!1})}function ma(){return new Rn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:os(),fragmentShader:`
		...
		`,blending:ln,depthTest:!1,depthWrite:!1})}function ga(){return new Rn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:os(),fragmentShader:`
...
`].filter(_i).join(`
`)),o=es(o),o=ba(o,t),o=Aa(o,t),a=es(a),a=ba(a,t),a=Aa(a,t),o=wa(o),a=wa(a),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(T=`#version 300 es
